    ...
    return (
        <footer className="bg-gray-300">
            <div className="max-w-screen-xl px-4 py-10 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <div className="flex mt-8 space-x-6 text-gray-600">
                            <a className="hover:opacity-75" rel="noreferrer">
                ...
                <div className="mt-8 text-xs text-center text-gray-800">
                    <p>
                        © {new Date().getFullYear()} Ziaul.dev — All Rights Reserved | Designed & Developed with by <span className="text-blue-500 font-heading">Ziaul Hoque</span>
                    </p>
                </div>
            </div>
        </footer>
